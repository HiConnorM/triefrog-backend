...
export async function ensureSampleRepo(repoPath: string): Promise<void> {
...
`,
  ...
  writeFile(
    path.join(repoPath, 'app', 'dashboard', 'page.tsx'),
...
`,
  ...
  writeFile(
    path.join(repoPath, 'app', 'settings', 'page.tsx'),
...
`,
  ...
  writeFile(
    path.join(repoPath, 'app', 'api', 'users', 'route.ts'),
...
`,
  ...
  writeFile(
    path.join(repoPath, 'app', 'api', 'projects', 'route.ts'),
    `import { NextRequest, NextResponse } from 'next/server';
import { PrismaClient } from '@prisma/client';
...
`,
  ...
  writeFile(
    path.join(repoPath, 'app', 'api', 'scans', 'route.ts'),
    `import { NextRequest, NextResponse } from 'next/server';
import { PrismaClient } from '@prisma/client';
